  ...
  return (
    <button type={type} className={`${full && 'w-full'} button-shadow hover:button-sink`} onClick={handleCopy} style={{ width: '150px', height: '50px' }}>
      <div className="flex items-center justify-center h-full">
        ...
        <span className="fold-bold relative inline-block h-full w-full rounded border-2 border-black bg-white px-3 py-1 text-base font-bold text-black transition duration-100 hover:bg-red-90 hover:text-white">
            {isCopied ? (

  ...
  return (
    <button type={type} className={`flex items-center justify-center ${full ? 'w-full' : ''} button-shadow hover:button-sink`}>
      <div className="relative">
        <span className="relative inline-block h-full w-full rounded border-2 border-black bg-white px-2 py-1 text-base font-bold text-black transition duration-100 hover:bg-red-90 hover:text-white">
